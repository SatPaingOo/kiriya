 ...
 * environment given turns it on; FORCE_COLOR from the outside never leaks in, and the
 * configuration file is an empty one unless the environment names another.
 */
