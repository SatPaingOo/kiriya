...
const BASH = [
  ...
  "  local i",
  "  # Word by word: bash 3.2, as macOS ships it, joins a sliced array into one word.",
  "  for ((i = 1; i < COMP_CWORD; i++)); do",
  '    args+=("--word=${COMP_WORDS[i]}")',
  "  done",
  "  local lines",
  ...
  "  COMPREPLY=($(printf '%s\\n' \"$lines\" | cut -f1))",
  "}",
  "# With no suggestion, -o default lets bash complete file names.",
  "complete -o default -F _kiriya_complete kiriya",
];
